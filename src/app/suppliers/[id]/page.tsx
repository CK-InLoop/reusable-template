      ...
      <section className="mt-8 rounded-lg border border-[#e2e8f0] bg-white p-6 shadow-sm">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-center">
          ...
          <a
            ...
            className="flex items-center justify-center gap-2 px-10 py-4 bg-[#25D366] text-white text-sm font-semibold rounded-md hover:bg-[#1da851] transition whitespace-nowrap"
          >
          ...
          <a
            ...
            className="flex items-center justify-center gap-2 px-10 py-4 bg-[#0b4f82] text-white text-sm font-semibold rounded-md hover:bg-[#0a3d6b] transition whitespace-nowrap"
          >
