              ...
              <div>
                ...
                <div className="mt-8 grid gap-4 sm:grid-cols-2">
                  {supportItems.map((item) => (
                    <div
                      key={item}
                      className="rounded-lg border border-[#e2e8f0] bg-[#f8fafc] p-4 text-sm text-[#171717]"
                    >
                      <p className="font-semibold text-[#0b4f82]">
                        {formatText(item)}
                      </p>
                    </div>
                  ))}
                ...
                <div className="mt-10 space-y-2 text-sm text-[#64748b]">
                ...
                <div className="mt-8 flex items-center gap-3 rounded-lg border border-[#e2e8f0] bg-[#f8fafc] p-4">
                  <svg
